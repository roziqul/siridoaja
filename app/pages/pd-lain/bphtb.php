<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item">BPHTB</div>
        </div>
    </div>
                    ...
                    <table class="table table-striped" id="table-1">
                        <thead>
                            <tr style="font-size: 12px;">
                                ...
                                <th class="text-center">NAMA YANG MEMPEROLEH</th>
                                <th class="text-center">ALAMAT</th>
                                <th class="text-center">NAMA ASAL</th>
                                <th class="text-center">ALAMAT</th>
                                ...
                                <th class="text-center">NJOP.BANG.</th>
                                <th class="text-center">AJB.</th>
...
<script>
    ...
    function loadData(evt) {
        ...
        $('#table-1>tbody').empty();
        $.ajax({
            url: "dummy/pajak-daerah-lain/data-bphtb.php",
            type: 'GET',
            dataType: 'json',
