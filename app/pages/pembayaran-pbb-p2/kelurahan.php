<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item">PBB-P2 Kelurahan</div>
        </div>
    </div>
            ...
            <div class="card-body">
                <form class="form-inline mb-4" onsubmit="loadData(event)">
                    <div class="input-group mx-0 mx-md-2 mb-3 mb-md-0">
                        ...
                        <select id="tahun" name="tahun" class="form-control" style="width: 100px;">
                    ...
                    <button type="submit" class="btn btn-icon icon-left btn-primary" style="margin-left: 10px;">
...
<script>
    ...
    // Modify the loadData function to include the selected kecamatan value
    function loadData(evt) {
        var tahun = evt.target.elements.tahun.value;
        var kecamatan = evt.target.elements.kecamatan.value;
        initTable(true);
        ...
        $('#table-1>tbody').empty();
        $.ajax({
            url: "dummy/pembayaran-pbb-p2/pembayaran-d2.php",
            type: 'GET',
            dataType: 'json',
